            ...
            <div className="flex flex-col justify-center gap-2 lg:gap-10 w-full lg:w-2/3 min-w-0 flex-1">
                ...
                <div className="flex flex-wrap items-center gap-6 sm:gap-8">
                    <a
                        ...
                        className="inline-flex w-fit items-start gap-2 rounded-md border-2 border-cyan-600 bg-transparent px-4 py-3 font-semibold text-slate-900 transition-colors duration-400 ease-in-out hover:bg-cyan-600 hover:text-white dark:border-cyan-400 dark:text-white dark:hover:bg-cyan-400 dark:hover:text-slate-900"
                    >
