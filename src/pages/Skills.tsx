    ...
    return (
        <div className="flex w-full flex-col items-center gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="flex w-full max-w-7xl flex-col gap-8 sm:gap-10">
                {/* Each category reveals on its own as it scrolls in */}
                                ...
                                {items.map((skill) => (
                                    <li key={skill.name}>
                                        <a href={skill.url} target="_blank" rel="noopener noreferrer"
                                            ...
                                            className="group relative flex h-full flex-col items-center justify-center gap-3 p-3 rounded-xl border border-slate-200 bg-white/40 transition-colors duration-300 hover:border-cyan-500/50 hover:bg-white/60 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/8 sm:gap-4 sm:p-6">
                                            ...
                                            <span className="text-center text-xs font-medium text-slate-700 dark:text-slate-200 sm:text-base">
                                                {skill.name}
                                            </span>
                                        </a>
                                    </li>
