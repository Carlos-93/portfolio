        ...
        <div className="flex w-full flex-col items-center gap-10">
            ...
            <ol className="relative w-full max-w-7xl">
                ...
                <span aria-hidden="true"
                    className="pointer-events-none absolute top-2 bottom-2 left-7 w-0.5 -translate-x-1/2 rounded-full bg-linear-to-b from-cyan-500/0 via-cyan-500/50 to-cyan-500/0 md:left-1/2" />
                    ...
                    return (
                        <li key={exp.id} className="relative mb-10 last:mb-0">
                            ...
                            <div className="absolute top-1 left-7 z-10 -translate-x-1/2 md:left-1/2">
                                <div className="h-14 w-14 overflow-hidden rounded-full ring-2 ring-cyan-500/60 transition-transform duration-300 hover:scale-105 md:h-20 md:w-20">
                                    <img src={exp.logo} alt={exp.company} loading="lazy" className="h-full w-full object-cover" />
                                </div>
                            ...
                            <div className={`ml-20 md:w-[calc(50%-3rem)] ${left ? 'md:ml-0 md:mr-auto' : 'md:ml-auto md:mr-0'}`}>
                                <article className="rounded-2xl border border-slate-200 bg-white/50 p-5 backdrop-blur-sm transition-colors duration-300 hover:border-cyan-500/50 dark:border-white/10 dark:bg-white/5 sm:p-6">
                                    ...
                                    <div className="mt-3 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-slate-500 dark:text-gray-400">
                                    ...
                                    <span className="mt-3 inline-block rounded-full border border-slate-200 bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-600 dark:border-white/10 dark:bg-white/10 dark:text-gray-300">
