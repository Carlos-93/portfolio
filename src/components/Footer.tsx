...
export default function Footer() {
    ...
    return (
        <footer className="px-4 py-6 sm:px-6 sm:py-8 bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 text-gray-300 border-t border-gray-600 z-10" role="contentinfo">
